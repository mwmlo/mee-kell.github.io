...
export default function Overview() {
    return (
        <div className="overview">
            ...
            <h2 id="full-stack">Fully developed web platforms</h2>
                <Card no={[3,1]}
                    img={clicknotes} 
                ...
                <Card no={[3,4]}
                    img={gradder} 
                    title={"Gradder"} 
                    desc={"Gradder is an affordable, user-friendly, and multi-functional adaptive AI-based school management system. I worked as an intern and front-end developer to implement the user interface."} 
                    url={"https://github.com/Gradder-Official/gradder_main"} 
                />
            <h2 id="hacks">Hackathon projects</h2>
                <Card no={[5,1]}
                    img={tempad} 
                ...
                />
            <h2 id="experiments">Other experiments</h2>
